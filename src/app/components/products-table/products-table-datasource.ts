...
const EXAMPLE_DATA: ProductsTableItem[] = [
  {id: 1, name: 'Hydrogen', price: 5, promotion: 'tanio', market: 'lidl'},
  {id: 2, name: 'Helium', price: 6, promotion: 'drogo', market: 'biedra'},
];
  ...
  private getSortedData(data: ProductsTableItem[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        ...
        case 'promotion': return compare(a.id, b.id, isAsc);
        case 'market': return compare(a.id, b.id, isAsc);
        default: return 0;
      }
    });
  }
